...
export default function UsersPanel() {
    ...
    if (error) return <div className="p-6 text-sm text-red-500">Failed to load users: {error}</div>;
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                <input
                    ...
                    className="w-full sm:w-80 rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-black/10"
                />
                <select
                    value={roleFilter}
